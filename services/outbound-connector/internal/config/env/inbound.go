...
type inboundConsumerEnvConfig struct {
	Topic     string   `env:"KAFKA_OUTBOUND_TOPIC_NAME" envDefault:"esb.inbound.raw"`
	GroupID   string   `env:"KAFKA_OUTBOUND_CONSUMER_GROUP_ID" envDefault:"esb-inbound-group-raw"`
...
func (cfg *inboundConsumerConfig) Endpoints() []string {
	return cfg.raw.Endpoints
}
